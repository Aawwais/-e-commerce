...
const MenuCard = () => {
  return (
    <div className="max-w-sm cursor-pointer rounded overflow-hidden shadow-lg bg-white transform transition duration-500 hover:scale-110 hover:bg-black hover:bg-opacity-5 hover:inset-0 hover:border-4 hover:border-customGreen ">
